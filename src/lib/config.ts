...
export const HACKATHON_SLUG = 'cursor-kigali-hackathon-2026-06-21'
export const HACKATHON_PATH = `/${HACKATHON_SLUG}`
export const HACKATHON_DATE_ISO = '2026-06-21'
export const HACKATHON_DATE_LABEL = 'Sunday, 21 June 2026'
